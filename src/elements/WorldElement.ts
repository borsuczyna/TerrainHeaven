...
export interface ElementData {
    ...
    // Building-specific
    buildingSegments?: { x: number; y: number; z: number; width: number; depth: number; wallHeight?: number; roofRidgeHeight?: number; roofOverhang?: number; separateRoof?: boolean }[];
